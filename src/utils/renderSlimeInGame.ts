...
export function renderSlimesInGame(p5: P5): void {
    ...
    if (player1Slime.isCharging) {
        ...
        const triangleX = (player1Slime.x + gameState.player.chargeTriangleOffsetX * scale) * width
        const triangleY = (player1Slime.y + gameState.player.chargeTriangleOffsetY) * height
